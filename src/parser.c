...
static const uint32_t ts_small_parse_table_map[] = {
  ...
  [SMALL_STATE(112)] = 1556,
  [SMALL_STATE(113)] = 1563,
  [SMALL_STATE(114)] = 1570,
  [SMALL_STATE(115)] = 1577,
  [SMALL_STATE(116)] = 1584,
  [SMALL_STATE(117)] = 1591,
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [35] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_procedure_division_repeat1, 2, 0, 0), SHIFT_REPEAT(101),
  [38] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_procedure_division_repeat1, 2, 0, 0), SHIFT_REPEAT(44),
  [41] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_procedure_division_repeat1, 2, 0, 0), SHIFT_REPEAT(111),
  ...
  [59] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_sentence_repeat1, 2, 0, 0), SHIFT_REPEAT(101),
  [62] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_sentence_repeat1, 2, 0, 0), SHIFT_REPEAT(44),
  [65] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_sentence_repeat1, 2, 0, 0), SHIFT_REPEAT(111),
  ...
  [91] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_move_statement, 4, 0, 0),
  [93] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_move_statement, 4, 0, 0),
  [95] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_using_clause_repeat1, 2, 0, 0), SHIFT_REPEAT(15),
  [98] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_using_clause_repeat1, 2, 0, 0),
  [100] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_using_clause_repeat1, 2, 0, 0),
  [102] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_statement, 1, 0, 0),
  [104] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_identifier_or_string, 1, 0, 0),
  [106] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_copy_statement, 2, 0, 1),
  [108] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_perform_statement, 2, 0, 0),
  [110] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_stop_statement, 2, 0, 0),
  [112] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_statement, 5, 0, 3),
  [114] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_statement, 7, 0, 8),
  [116] = {.entry = {.count = 1, .reusable = true}}, SHIFT(78),
  [118] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_identification_division, 5, 0, 0),
  [120] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_identification_division, 4, 0, 0),
  [122] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_identification_division_repeat1, 2, 0, 0), SHIFT_REPEAT(78),
  [125] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_identification_division_repeat1, 2, 0, 0),
  ...
  [135] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_data_division, 3, 0, 0),
  [137] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_data_division, 4, 0, 0),
  [139] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_data_division_repeat1, 2, 0, 0), SHIFT_REPEAT(86),
  [142] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_data_division_repeat1, 2, 0, 0), SHIFT_REPEAT(80),
  [145] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_data_division_repeat1, 2, 0, 0),
  [147] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sentence, 2, 0, 0),
  ...
  [155] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_identification_paragraph, 4, 0, 0),
  [157] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_file_section, 3, 0, 0),
  [159] = {.entry = {.count = 1, .reusable = true}}, SHIFT(77),
  [161] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_working_storage_section, 3, 0, 0),
  [163] = {.entry = {.count = 1, .reusable = true}}, SHIFT(82),
  [165] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_configuration_section, 3, 0, 0),
  [167] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_program_id_paragraph, 4, 0, 2),
  [169] = {.entry = {.count = 1, .reusable = true}}, SHIFT(121),
  [171] = {.entry = {.count = 1, .reusable = true}}, SHIFT(98),
  [173] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_environment_division, 3, 0, 0),
  [175] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_configuration_section, 4, 0, 0),
  [177] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_working_storage_section, 4, 0, 0),
  [179] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_file_section, 4, 0, 0),
  [181] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_configuration_section_repeat1, 2, 0, 0), SHIFT_REPEAT(82),
  [184] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_configuration_section_repeat1, 2, 0, 0),
  [186] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_working_storage_section_repeat1, 2, 0, 0),
  [188] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_working_storage_section_repeat1, 2, 0, 0), SHIFT_REPEAT(77),
  ...
  [199] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_file_control_paragraph, 2, 0, 0),
  [201] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_file_control_paragraph, 3, 0, 0),
  [203] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_file_control_paragraph_repeat1, 2, 0, 0), SHIFT_REPEAT(100),
  [206] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_file_control_paragraph_repeat1, 2, 0, 0),
  [208] = {.entry = {.count = 1, .reusable = true}}, SHIFT(84),
  [210] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_input_output_section, 3, 0, 0),
  [212] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_data_description_entry, 5, 0, 4),
  [214] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_computer_paragraph, 4, 0, 5),
  [216] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_data_description_entry, 3, 0, 4),
  [218] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_data_description_entry, 4, 0, 4),
  [220] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_environment_division, 4, 0, 0),
  [222] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relational_operator, 1, 0, 0),
  [224] = {.entry = {.count = 1, .reusable = true}}, SHIFT(17),
  [226] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_data_section, 1, 0, 0),
  [228] = {.entry = {.count = 1, .reusable = true}}, SHIFT(15),
  [230] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_using_clause, 2, 0, 0),
  [232] = {.entry = {.count = 1, .reusable = true}}, SHIFT(56),
  [234] = {.entry = {.count = 1, .reusable = true}}, SHIFT(3),
  [236] = {.entry = {.count = 1, .reusable = true}}, SHIFT(66),
  [238] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_select_statement, 6, 0, 9),
  [240] = {.entry = {.count = 1, .reusable = true}}, SHIFT(61),
  [242] = {.entry = {.count = 1, .reusable = true}}, SHIFT(14),
  [244] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_input_output_section, 4, 0, 0),
  [246] = {.entry = {.count = 1, .reusable = true}}, SHIFT(13),
  [248] = {.entry = {.count = 1, .reusable = true}}, SHIFT(21),
  [250] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_environment_division, 5, 0, 0),
  [252] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_picture_clause, 2, 0, 6),
  ...
  [286] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_condition, 3, 0, 0),
  ...
  [294] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_file, 4, 0, 0),
  ...
  [328] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_value_clause, 2, 0, 7),
